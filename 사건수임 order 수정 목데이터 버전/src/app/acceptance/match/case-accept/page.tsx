...
export default function CaseAcceptPage() {
  ...
  const filteredData = caseData?.data.filter((item) => item.order !== "5")
    ...
    >
      ...
      <section ref={rootRef}>
        ...
        <div className="pt-[24px] px-4 pb-10" ref={el}>
          ...
          {(caseData?.data?.length > 0 || filteredData?.length > 0) ?
            (
            <>
              <div className="flex items-center">
                ...
                >
                  ...
                  총 {isBeforeNine ? filteredData?.length : caseData?.data?.length}건의 사건이 있어요
                </Typography>
                {/* 리프레시버튼 추가 */}
                {/* <button
                type="button"
